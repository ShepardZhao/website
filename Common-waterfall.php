...
<script src="assets/framework/js/jquery.imagesloaded.js"></script>
<script src="assets/framework/js/jquery.wookmark.min.js"></script>
<script src="assets/framework/js/customer-waterfall.js"></script>
